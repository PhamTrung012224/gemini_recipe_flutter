...
//
// I'm in the mood for the following types of cuisine: All over the world
//
// I followed these dietary restrictions: none
//
// I also have the following ingredients: none
//
...
//
// If none of information are given, provide random recipe from random cuisines.
//
// No Yapping!
// Note: Return the recipe in JSON using the following structure, with 10 dishes:
// {'dish':[
// {
//   'title': \$recipeTitle,
//   'category': \$category,
...
// }
//
// category should be one of these type: Breakfast recipes, Lunch recipes, Dinner recipes, Salad recipes, Soup recipes, Dessert recipes, Vegetarian Dishes
...
stepTitle should be the brief description of its step
meal should be one of these type: Breakfast, Brunch, Elevenses, Lunch, Tea, Supper, Dinner.
calories should have unit kcal
uniqueId should be unique and of type String.
title, meal, description, cuisine, allergens, and servings should be of String type.
